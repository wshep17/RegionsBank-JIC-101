				...
				<Row gutter={10} style={{paddingTop: '70px'}}>
					<Col span={10} style={{margin: 'auto'}}>
						<Card title="Create An Account!" bordered={true}>
							Name: 
							<Input placeholder="John Doe" name='name' value={this.state.name} onChange={this.handleChange}/>
						<br />
						<br />
							Email: 
							<Input placeholder="john@bank.com" name='email' value={this.state.email} onChange={this.handleChange}/>
						<br />
						<br />
							Password: 
							<Input.Password placeholder="p@$$w0r6" name='password' value={this.state.password} onChange={this.handleChange}/>
						<br />
						<br />
